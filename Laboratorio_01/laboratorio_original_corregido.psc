Algoritmo laboratorio
	...
	// Creando contador
	// Guardando variable para sacar dia con menor ventas
	dias_trabajados = mes
	i = 1
	...
	Mientras mes > 0 Hacer
		escribir "Ingresa los valores de sus ventas diarias: "
		leer ventas
	...
	// Calculando correctamente los dias que superan el promedio
	dias_mayor_promedio = 0
	Para i = 1 Hasta dias_trabajados Hacer
		si ventas_dia[i] > promedio_de_ventas Entonces
	...
	// Este codigo es el mismo que el original pero con arreglos para que funcione correctamente todo.
