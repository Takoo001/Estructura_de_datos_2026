...
public class Lab_02_2 {
    public static void main(String[] args) {
        ...
        System.out.println("Su promedio de notas de laboratorio es: " + String.format("%.1f", promedioLaboratorio));
        ...
        // Entregando el promedio de notas de "pruebas"
        System.out.println("Su promedio de notas de pruebas es: " + String.format("%.2f", promedioPruebas));
        System.out.println("");
        // Pidiendo ponderacion de laboratorios y pruebas para calcular la nota final
        System.out.println("Ingrese la ponderacion de notas de laboratorio (%) ej: 0,15");
        double PONDERACION_LABORATORIO = teclado.nextDouble();
        System.out.println("");
        System.out.println("Ingrese la ponderacion de notas de prueba (%) ej: 0,15");
        double PONDERACION_PRUEBAS = teclado.nextDouble();

        System.out.println("");
        // Calculando la nota final
        double notaFinal = PONDERACION_LABORATORIO * (promedioLaboratorio) + PONDERACION_PRUEBAS * (promedioPruebas);
        
        // Evaluando si el estudiante aprueba el modulo o no
        if (notaFinal >= 4.0) {
            System.out.println("Usted aprobo el modulo con un promedio total ponderado de: " + String.format("%.1f", notaFinal));
        } else {
            System.out.println("Usted reprueba el modulo con un promedio total ponderado de: " + String.format("%.1f", notaFinal));
        }
