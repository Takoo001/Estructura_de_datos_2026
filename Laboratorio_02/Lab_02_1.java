...
public class Lab_02_1 {
    public static void main(String[] args) {
        ...
        // Creando ponderaciones (Al ser constantes se le agrega "final")
        final double PONDERACION_LABORATORIO = 0.30;
        final double PONDERACION_PRUEBAS = 0.70;
        ...
        System.out.println("");
        System.out.println("Su promedio de notas de pruebas es: " + String.format("%.1f", promedioPruebas));
